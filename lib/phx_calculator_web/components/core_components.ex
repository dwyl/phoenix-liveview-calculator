defmodule PhxCalculatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhxCalculatorWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhxCalculatorWeb.Gettext, "errors", msg, opts)
    # end
